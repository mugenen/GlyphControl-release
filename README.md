...
Thanks to the open-source diffusion codes or demos: [DALL-E 2](https://openai.com/product/dall-e-2), [Stable Diffusion V2.0](https://github.com/CompVis/stable-diffusion), [Stable Diffusion XL](https://dreamstudio.ai/generate), [DeepFloyd](https://github.com/deep-floyd/IF).
